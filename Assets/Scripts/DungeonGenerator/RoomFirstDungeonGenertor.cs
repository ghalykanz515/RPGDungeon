...
{
    public class RoomFirstDungeonGenertor : RandomWalkDungeonGenerator
    {
        ...
        {
            var roomsList = DungeonGenerator.BinarySpacePartitioning(new BoundsInt((Vector3Int)startPos, new Vector3Int
